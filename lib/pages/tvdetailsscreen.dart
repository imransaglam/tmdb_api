...
class TvDetailsScreen extends StatefulWidget {
  const TvDetailsScreen({super.key, required this.tv_id, required this.index, });
  final String tv_id;
  final int index;
...
class _TvDetailsScreenState extends State<TvDetailsScreen> {
  ...
  void initState() {
   ...
   print(widget.tv_id);
     Provider.of<TmdbProvider>(context,listen: false).getGetTvSeriesData(tv_id: widget.tv_id, tv_index: widget.index);
    Provider.of<TmdbProvider>(context,listen: false).getTvCastData(tv_ids: widget.tv_id, tv_indexes: widget.index);
    super.initState();
  }
  @override
        ...
        child: Column(
          ...
          children: [
                ...
                Consumer(
                   ...
                   Container(
                      ...
                      decoration: BoxDecoration(
                                          image: DecorationImage(
                                            image:NetworkImage("https://image.tmdb.org/t/p/w600_and_h900_bestv2/${getTvSerieProvider.tvSeriesResponse.results![widget.index].posterPath}"),
                                            fit: BoxFit.fill,
                                          ),
                                         ),
                    ),
                  ...
                  Padding(
                   ...
                   Positioned(
                    ...
                    left: 20,
                     child: Consumer(
                      builder: (context, TmdbProvider tvRateCircularProvider, child) =>
                        ...
                        Container(
                                ...
                                child: CircularProgressIndicator(
                                  ...
                                  value:(tvRateCircularProvider.tvSeriesResponse.results![widget.index].voteAverage)/10,
                                  strokeWidth: 7,
                                ),
                              ),
                     ),
                   ...
                   Positioned(
                    ...
                    child: Consumer(
                       builder: (context, TmdbProvider tvRateCircularProvider, child) =>
                          tvRateCircularProvider.isTvSeriesResponseLoading == true
                              ? CircularProgressIndicator():
                      Text(tvRateCircularProvider.tvSeriesResponse.results![widget.index].voteAverage.toString(),style: TextStyle(color:Colors.white,fontSize: 18,fontWeight:FontWeight.bold),))),
                     Positioned(
                       bottom: 40,
                       left: 100,
                       child: Consumer(
                         builder: (context, TmdbProvider tvTitleProvider, child) =>
                          tvTitleProvider.isTvSeriesResponseLoading == true
                              ? CircularProgressIndicator():
                         Text(tvTitleProvider.tvSeriesResponse.results![widget.index].originalName.toString(),style: TextStyle(color:Colors.white,fontSize: 22,fontWeight: FontWeight.bold),)),
                     ),
                   Positioned(
                     bottom: 13,
                     left: 100,
                     child: Consumer(
                        builder: (context, TmdbProvider firstAirDateProvider, child) =>
                          firstAirDateProvider.isTvSeriesResponseLoading == true
                              ? CircularProgressIndicator():
                       Row(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text(firstAirDateProvider.tvSeriesResponse.results![widget.index].firstAirDate.toString(),style: TextStyle(color:Color(0xffbbbbbb),fontSize: 16,fontWeight: FontWeight.w400),),
                                  SizedBox(width: 10,),
                                  Padding(
                                  ...
                                  Text(firstAirDateProvider.tvSeriesResponse.results![widget.index].originalLanguage.toString(),style: TextStyle(color:Color(0xffbbbbbb),fontSize: 16,fontWeight: FontWeight.w400),),
                                ],
                              ),
                     ),
                   )
           ...
           Padding(
             ...
             child: Consumer(
              builder: (context, TmdbProvider isTvSeriesResponseLoading, child) =>
                          isTvSeriesResponseLoading.isTvSeriesResponseLoading == true
                              ? CircularProgressIndicator():
              Text(isTvSeriesResponseLoading.tvSeriesResponse.results![widget.index].overview.toString(),style: TextStyle(color: Color(0xffCCCCCC),fontSize: 14,fontWeight: FontWeight.w400),)),
           ),
           Padding(
                 ...
                 child: Consumer(
                   builder: (context, TmdbProvider tvCastProvider, child) =>
                    ...
                    child: ListView.builder(
                      shrinkWrap: true,
                      itemCount: tvCastProvider.tvCastResponse.cast!.length,
                         ...
                         crossAxisAlignment: CrossAxisAlignment.center,
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                                  image: DecorationImage(
                                                    image:NetworkImage("https://image.tmdb.org/t/p/w600_and_h900_bestv2/${tvCastProvider.tvCastResponse.cast![index].profilePath}"),
                                                    fit: BoxFit.fill,
                                                  ),
                                                  border: Border.all(
                          color: Color(0xff303243),
                            ...
                            Container(
                              ...
                              child: Padding(
                                ...
                                child: Text(
                                  ...
                                  tvCastProvider.tvCastResponse.cast![index].name.toString(),
